...
public class RecipeLogicInsaneSteam extends AbstractRecipeLogic implements IVentable {
    ...
    private final boolean isInsanePressure;
    ...
    private void performVentingAnimation(BlockPos ventingBlockPos, BlockPos machinePos) {
        metaTileEntity.getWorld()
                ...
                .forEach(entity -> {
                    entity.attackEntityFrom(DamageSources.getHeatDamage(), this.isInsanePressure ? 12.0f : 6.0f);
    ...
    protected int[] calculateOverclock(@NotNull Recipe recipe) {
        ...
        result[0] = isInsanePressure ? recipe.getEUt() * 4 : recipe.getEUt();
        result[1] = isInsanePressure ? recipe.getDuration() : recipe.getDuration() * 4;
