...
public class RenderChunkMixin {
    ...
    public boolean lockBuilding(BlockRendererDispatcher dispatcher, IBlockState state, BlockPos pos, IBlockAccess blockAccess, BufferBuilder bufferBuilder, Operation<Boolean> method) {
